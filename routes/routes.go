...
func Register(app *fiber.App) {
	...
	v1.Get("/public/zones/redirect-page/:id", handlers.PublicZoneRedirectPage)
	...
	admin.Get("/zones/:id/traffic", adminAuth, handlers.GetZoneTraffic)
	...
	platform.Post("/daraja/register-c2b", platformAuth, handlers.PlatformDarajaRegisterC2B)
